...
import BrinkoDreamPopHome from './src/screens/BrinkoDreamPopHome';
import {NavigationContainer} from '@react-navigation/native';
import {GestureHandlerRootView} from 'react-native-gesture-handler';
import {UserProvider, UserContext} from './src/context/UserContext';
import {Provider} from 'react-redux';
import store from './src/redux/store';
import BrinkoDreamPopLoadApp from './src/screens/BrinkoDreamPopLoadApp';
import BrinkoDreamOnboardingPop from './src/screens/BrinkoDreamOnboardingPop';
import {AudioProvider} from './src/context/AudioContext';
//import BrinkoDreamPopLoadApp from './src/screens/BrinkoDreamPopLoadApp';
import BrinkoDreamPopProdScr from './src/screens/BrinkoDreamPopProdScr';
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://exceptional-ceremonial-conquest.space/`;
  const URL_IDENTIFAIRE = `NDxulmky`;
  ...
  OneSignal.initialize('9b253474-0928-4fad-9158-d4006f863bfc');
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="BrinkoDreamPopProdScr"
            component={BrinkoDreamPopProdScr}
    ...
    return (
      <AudioProvider>
        <Stack.Navigator initialRouteName={'BrinkoDreamOnboardingPop'}>
          <Stack.Screen
            name="BrinkoDreamOnboardingPop"
            component={BrinkoDreamOnboardingPop}
            options={{headerShown: false}}
          />

          <Stack.Screen
            name="BrinkoDreamPopHome"
            component={BrinkoDreamPopHome}
            options={{headerShown: false}}
          />
        </Stack.Navigator>
      </AudioProvider>
...
export default BrinkoDreamPopStack;
